...
public class Lab6 extends JFrame {
    ...
    public static void main(String[] args) {
        new Lab6("JAVA LAB", frameWidth, frameHeight);
    }

    Lab6(String s, int w, int h) {
        super(s);
        setSize(w, h);
        setVisible(true);
    ...
    public void drawProductInput(JPanel jpanel, JLabel label, JTextField name, JTextField price, int offsetY, int currentIndex) {
        ...
        label.setBounds(0, offsetY, 100, 30);
        label.setForeground(textColor);
        jpanel.add(label);

        name.setFont(textFont);
        name.setBounds(80, offsetY, 120, 30);
        name.setForeground(textColor);
        jpanel.add(name);

        price.setFont(textFont);
        price.setBounds(250, offsetY, 80, 30);
        ...
        try {
            ...
            imgLabel.setBounds(380, offsetY, 100, 100);
    ...
    public String validateInput(JTextField[] names, JTextField[] prices){
        for (JTextField name: names) {
            if(Objects.equals(name.getText(), "")){
                return "Form contains empty product name";
            }
        }

        for (JTextField price: prices ) {
            if(Objects.equals(price.getText(), "")){
                return "Form contains empty product price";
            }
            if(Float.parseFloat(price.getText()) < 0){
                return "Form contains negative product price";
            }
        }
        return "";
    }
    ...
    private void showDialog(String message, boolean exitOnClose)
    {
        ...
        recallBtn.setBounds(100, 100, 200, 45);
        errorDialog.add(recallBtn);

        errorDialog.setBounds(300, 200, 400, 200);
    ...
    public void paint(Graphics g) {
        ...
        submitBtn.setBounds(0, 80 * (productsCount + 1), 130, 50);
        ...
        closeBtn.setBounds(180, 80 * (productsCount + 1), 130, 50);
